...
mod tests {
    ...
    fn test_decode() {
        unsafe {
            ...
            let send_b: Vec<u8> = vec![0; KYBER_CIPHERTEXTBYTES as usize];
            let sk_a: Vec<u8> = vec![0; KYBER_SECRETKEYBYTES as usize];

            let expected_key_a: Vec<u8> = vec![
                160, 158, 123, 88, 195, 221, 144, 132, 239, 112, 79, 27, 129, 240, 212, 8, 26, 81,
                138, 214, 114, 135, 124, 174, 183, 114, 186, 220, 103, 23, 227, 88,
            ];
